  ...
  cupertino_icons、intl、styled_widget、sqlite3、drift、path_provider、path、fl_chart、shared_preferences、pdfx、flutter_slidable、image_picker、flutter_image_compress、table_calendar、lunar、sensors_plus、flutter_svg、audioplayers、carousel_slider、ffi、file_selector、url_launcher...''',
              ...
              _buildSection(
                ...
                Column(
                  ...
                  children: const [
                    SizedBox(height: 8),
                    Text('v1.1.1 (2026-08-15)', textAlign: TextAlign.left),
                    Text('• 增加桌面卡片，增加开示功能', textAlign: TextAlign.left),
                    Text('v1.0.8 (2026-08-05)', textAlign: TextAlign.left),
                    Text('• 电子木鱼增加十念法', textAlign: TextAlign.left),
                    Text('v1.0.7 (2026-04-05)', textAlign: TextAlign.left),
                    Text('• 增加听书功能', textAlign: TextAlign.left),
